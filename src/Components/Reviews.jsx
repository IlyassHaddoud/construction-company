...
const Reviews = () => {
  const [clients, setClients] = useState([
    ...
    },
    {
      ...
      fonction: "Marketing Manager, Radiant Cosmetics",
      comment:
    ...
    },
    {
      ...
      image: client3,
      name: "Sophia Roberts",
      fonction: "Founder, Nature's Bliss Retreats",
      comment:
    ...
    },
    {
      ...
      image: client4,
      name: "David Anderson",
      fonction: "VP of Sales, Pinnacle Industries",
      comment:
